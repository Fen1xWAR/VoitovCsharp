...
//   echo $db->error;
  ...
  function dodb() {   // Создание базы данных
   ...
   function do_tbpersons($id,$fio,$cp) {  // Создание таблицы spersons
    ...
    $r=  mysqli_query($sq);             // создаем таблицу
    echo mysql_error();
...
<br>
<input type=button value="Создание базы данных" onclick= <?php dodb(); ?>  >
<input type=button value="Создание таблицы spersons" onclick= <?php dodb(); ?>>
<input type=button value="Чтение таблицы spersons" onclick= <?php dodb(); ?>>
<br><input type=button value="Добавить персону" onclick= <?php dodb(); ?> >
